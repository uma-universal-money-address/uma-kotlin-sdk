 ...
 *
 * NOTE: In the future, we may want to support multiple major versions in the same SDK, but for now, this keeps things
 * simple.
 */
...
fun selectHighestSupportedVersion(otherVaspSupportedMajorVersions: List<Int>): String? {
    val highestSupportedMajorVersion =
      otherVaspSupportedMajorVersions.filter { supportedMajorVersions().contains(it) }.maxOrNull() ?: return null
